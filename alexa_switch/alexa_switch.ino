...
void turnOn(String deviceId) {
  if (deviceId == "5c39fe26dde46d6ba5ec7e28") // Device ID of first device
  {  
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    digitalWrite(device1,HIGH);
  } 
  else if (deviceId == "5c39fe36dde46d6ba5ec7e2a") // Device ID of second device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    digitalWrite(device2,HIGH);
  }
   else if (deviceId == "5c39fe64dde46d6ba5ec7e2f") // Device ID of third device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    digitalWrite(device3,HIGH);
  }
   else if (deviceId == "5c434ebd2069f45a06714bfc") // Device ID of fourth device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
    digitalWrite(device1,HIGH);
